        ...
        <div class="how-section1">
            <div class="row">
                <div class="col-md-6 how-img">
                    <img src="../imagenes/WEB MISION.png" class="rounded-circle img-fluid" alt="" />
                </div>
                <div class="col-md-6">
                    <h4>MISION</h4>
                    <p class="text-muted">La misión de nuestra farmacia es proporcionar productos y servicios
                        relacionados con la salud y el bienestar de nuestros clientes</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <h4>VISION</h4>
                    <p class="text-muted">En nuestra farmacia, aspiramos a ser un pilar de la comunidad, brindando un
                        servicio excepcional y cuidado compasivo a nuestros clientes
                        ademas ser el destino preferido para todas las necesidades de salud y bienestar, ofreciendo una
                        amplia gama de productos farmacéuticos de alta calidad
                        .</p>
                </div>
                <div class="col-md-6 how-img">
                    <img src="../imagenes/WEB VISION.png" class="rounded-circle img-fluid" alt="" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 how-img">
                    <img src="../imagenes/WEB VALORES.png" class="rounded-circle img-fluid" alt="" />
                </div>
                <div class="col-md-6">
                    <h4>VALORES</h4>
                    <p class="text-muted">Compromiso
                        Honestidad
                        Innovación
                        Responsabilidad
                        Colaboración</p>
