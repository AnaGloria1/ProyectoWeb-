...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="/Proyecto Web/usuario/index_usuario.php">Inicio<span class="sr-only">(current)</span></a>
                    </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="../vista/cerrarsesion.php">cerrar sesion</a>
            </li>
                </ul>
            </nav>
        </nav>
